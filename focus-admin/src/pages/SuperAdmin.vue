  ...
  <q-page padding>
    <q-card class="no-shadow" bordered>
      <q-card-section class="header-format-w">
        <div class="text-h6 "> <q-icon name="supervisor_account" size="25px" class="q-mr-sm"/> Head Admin</div> 
      </q-card-section>
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      accountTypeOptions: [
        { label: 'Head Admin', value: 2 },
        { label: 'Focus Workers', value: 3 },
        { label: 'Lending', value: 4 },
        { label: 'Employer', value: 5 },
        { label: 'Worker/Applicant', value: 6 }
      ],
